...
describe('Controller: CompoundResultsCntrl', function () {

  // load the controller's module
  beforeEach(module('we99App'));

  var CompoundResultsCntrl,
    scope,
  ...
  beforeEach(inject(function ($controller, $rootScope,$httpBackend) {
    ...
    CompoundResultsCntrl = $controller('CompoundResultsCntrl', {
      $scope: scope
    });
  }));
  ...
  it('should remove/add compounds from selected list when toggle function called', function () {
    ...
    //console.log(scope.compounds.length);
    var originalCount=scope.selectedCompounds.length;

    //toggle off compound
    scope.toggleCompound(scope.compounds[0]);
    expect(scope.selectedCompounds.length).toBe(originalCount-1);

    //toggle on
    scope.toggleCompound(scope.compounds[0]);
    expect(scope.selectedCompounds.length).toBe(originalCount);
