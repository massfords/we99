...
import edu.harvard.we99.jaxb.PlateMetricsAdapter;
...
public class PlateResult extends BaseEntity {
    ...
    @XmlJavaTypeAdapter(PlateMetricsAdapter.class)
    private Map<String,PlateMetrics> metrics = new HashMap<>();
    ...
    @Generated("generated by IDE")
    public Map<String, PlateMetrics> getMetrics() {
        return metrics;
    }

    @Generated("generated by IDE")
    public PlateResult setMetrics(Map<String, PlateMetrics> metrics) {
