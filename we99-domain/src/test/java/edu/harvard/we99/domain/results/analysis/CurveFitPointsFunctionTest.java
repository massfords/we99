...
public class CurveFitPointsFunctionTest {
    ...
    Double[] expectedYResponses2 =  { -0.41975189, 93.07786695};
    ...
    Double[] rawX2 = {1e-10, 6.309573444801929e-05};
    ...
    public void testGenerationOfExperimentPoints(){
        ...
        List<ExperimentPoint> input = createExperimentPoints(rawX2,expectedYResponses2);

        CurveFitPointsFunction cfpf = new CurveFitPointsFunction(params,numPoints, FitEquation.HILLEQUATION);
        List<CurveFitPoint> output = cfpf.apply(input);

        assertEquals(numPoints+1, output.size());
    }
