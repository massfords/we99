...
public class NormalizeForPercentEffectFunctionTest {
    ...
    public void testCompoundNormalization(){
        ...
        ResultStatus[] posStatus = { ResultStatus.EXCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED,
        ...
        ResultStatus[] negStatus = { ResultStatus.EXCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED,
                ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED,
                ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED,
                ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED};
        ...
        ResultStatus[] contStatus = { ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED,
                ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED,
                ResultStatus.INCLUDED, ResultStatus.INCLUDED, ResultStatus.INCLUDED};

        List<WellResults> positiveControlResults = makeWellResults(positive,posStatus,1);
        for(WellResults wr : positiveControlResults){
            wellTypes.put(wr.getCoordinate(),WellType.POSITIVE);
        }
        List<WellResults> negativeControlResults = makeWellResults(negative,negStatus,2);
        for(WellResults wr : negativeControlResults){
            wellTypes.put(wr.getCoordinate(),WellType.NEGATIVE);
        }
        List<WellResults> compundResults = makeWellResults(wellResults,contStatus,3);
     ...
     */
    private static List<WellResults> makeWellResults(Double[] values, ResultStatus[] status, int row){

        assert status.length == values.length;
        ...
        for(int i = 0; i < values.length; i++){
            ...
            when(wr.getResultStatus()).thenReturn(status[i]);
