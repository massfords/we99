...
insert into Permission(id, name) values (80, 'PERM_READ_RESULTS');
insert into Permission(id, name) values (81, 'PERM_MODIFY_RESULTS');
...
insert into Role_Permission (Role_id, permissions_id) values (1,80);
insert into Role_Permission (Role_id, permissions_id) values (1,81);
...
insert into Role_Permission (Role_id, permissions_id) values (2,80);
insert into Role_Permission (Role_id, permissions_id) values (2,81);
...
insert into Role_Permission (Role_id, permissions_id) values (3,80);
